...
// This is about show images 
const showImages = (images) => {
  resultImages(images.length);
  imagesArea.style.display = 'block';
  gallery.innerHTML = '';
  // This is about show gallery title
...
var timer
const createSlider = () => {
  // This is about check slider image length
  if (sliders.length < 2) {
    alert('Select at least 2 image.')
    return;
  }
  // This is about crate slider previous next area
...
// This is about change slider index 
const changeItem = index => {
  changeSlide(slideIndex += index);
}

// This is about change slide item
